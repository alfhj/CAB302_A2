...
public class Manifest {
	...
	/**
	 * Constructs a manifest given a reordering Stock while optimising the manifest's cost.
	 ...
	 * if the current truck runs out of space. The truck's type and temperature
	 * are determined automatically by the TruckFactory and Truck classes.
	 * 
